"use client";
import { allProducts, deleteProduct, searchProducts } from "@/actions/product";
...
const AllProducts = () => {
  ...
  const { sort, price, brand, quantity } = filterValues;
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-6 text-sm">
                              <Link
                                href={`/products/updateProduct?productId=${product._id}`}
